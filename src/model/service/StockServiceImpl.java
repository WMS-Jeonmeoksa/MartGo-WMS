...
public class StockServiceImpl implements StockService {
    ...
    public boolean checkIncomingStock(int incoming_num) {
    ...
    @Override
    public boolean checkIncomingStockHistory(int incoming_num) {
    ...
    public List<StockDTO> getUserStock(int user_id) {
        return stockDAO.checkStock(user_id).orElseGet(ArrayList::new);
    }
}
